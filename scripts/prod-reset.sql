...
DROP TABLE IF EXISTS local_user_actions;
DROP TABLE IF EXISTS local_user_cooldowns;
DROP TABLE IF EXISTS local_user_badges;
DROP TABLE IF EXISTS local_user_streaks;
DROP TABLE IF EXISTS local_spin_wins;
DROP TABLE IF EXISTS local_spin_daily_limits;
DROP TABLE IF EXISTS local_spin_offers;
