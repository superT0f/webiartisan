...
const routes = [
  ...
  { path: '/arene', component: () => import('./views/ArenaView.vue'), meta: { title: 'Arène' } },
  ...
  { path: '/beta', component: () => import('./views/BetaLanding.vue'), meta: { title: 'Rejoins la bêta fermée' } },
  { path: '/confidentialite', component: () => import('./views/Confidentialite.vue'), meta: { title: 'Politique de confidentialité' } },
